...
% explained variance of pc's - 12 components !
...
A natural step in continuing our analysis of the ADFA-LD 12 dataset are Support Vector Machines. At first we will keep the methodology we used previously so we can compare our results before moving forward.
