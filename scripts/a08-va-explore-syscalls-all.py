...
if exists('../data/a8_vamatrix.p'):
    ...
    with open('../data/a8_vamatrix.p', 'wb') as ha:
        pickle.dump(tmatrix, ha)

    print("System call statistics saved!")

# print tmatrix
print ("Number of validation set system calls that are not called is: {}".format(np.count_nonzero(tmatrix)))
