...
# results file
resultsfile = '../data/d08-1csvm-cv-nu-v2-results.txt'
...
with open('../data/d08-v2-acc1.p', 'wb') as ha:
    pickle.dump(acc1, ha)

with open('../data/d08-v2-fpr1.p', 'wb') as ha:
    pickle.dump(fpr1, ha)

with open('../data/d08-v2-acc1er.p', 'wb') as ha:
    pickle.dump(acc1er, ha)

with open('../data/d08-v2-fpr1er.p', 'wb') as ha:
...
#plt.show() 
plt.savefig('../pictures/d08-1csvm-v2.eps')
plt.close()
